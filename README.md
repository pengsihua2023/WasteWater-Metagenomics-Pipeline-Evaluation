...
|---|---|---|---:|---|---:|---:|---|---:|---|
| **#1** | Simulated (CDC) | `llnl_66ce4dde_R1.fastq.gz` + `llnl_66ce4dde_R2.fastq.gz` | 1.36 GB (670.52 MB + 693.43 MB) | `llnl_66d1047e.fastq.gz` | 263.93 MB | 1× | ≤ 48 hours (≤ 2 days) | 256 GB | Overall pipeline cap; assembly steps are typically the memory peak |
| **#2** | Real | `SRR35987572_1.fastq.gz` + `SRR35987572_1.fastq.gz`* | 289 GB (145 GB + 144 GB) | Not available | — | 212.5× | 2–7 days | 768 GB | Genome assembly software (assemblies dominate memory) |
